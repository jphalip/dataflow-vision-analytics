...
public class VideoLabelAnnotationProcessor implements VideoAnnotationResponseProcessor {
    ...
    public final static Counter counter =
            Metrics.counter(VideoAnnotationResponseProcessor.class, "numberOfLabelAnnotations");
