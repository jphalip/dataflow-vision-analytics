...
/**
 * Image annotation simulation class to test batching logic without incurring API costs.
 *
 * It simulates the delay of calling the API and produces a single annotation.
 */
public class AnnotateFilesSimulatorDoFn extends
    DoFn<Iterable<GCSFileInfo>, KV<GCSFileInfo, GeneratedMessageV3>> {

  private static final long serialVersionUID = 1L;

  public AnnotateFilesSimulatorDoFn(List<Feature.Type> imageFeatures, StreamingFeature videoFeature) {
    /*
  ...
  public void processElement(@Element Iterable<GCSFileInfo> fileInfos,
    ...
    VisionAnalyticsPipeline.numberOfImageApiRequests.inc();
    try {
      /**
